...
def render_terminal(symbol, p_days, cp, tw_val, api_ttl, v_comp, ws_p):
    ...
    # 🎯 核心修改 1：直接在 subplot_titles 嵌入 HTML 線標
    # 使用 &nbsp; 增加標題與線標間的距離
    ...
    # 🎯 核心修改 2：將所有 Trace 的 showlegend 設為 False，改用上面的手動線標
    # Row 1
    ...
    fig.update_layout(
        ...
        showlegend=False, # 關閉原生右側圖例
        margin=dict(l=10, r=10, t=50, b=50),
        paper_bgcolor='#000000', plot_bgcolor='#000000'
    )

    # 確保子圖標題靠左，且大小固定為 14px
