...
def render_terminal(symbol, p_days, cp, tw_val, api_ttl, v_comp, ws_p):
    ...
    fig.add_annotation(xref="paper", yref="paper", x=0.18, y=0.43, text="<span style='color:#FF5252'>■</span> 能量柱 <span style='color:#FFFFFF'>—</span> DIF <span style='color:#FFA726'>—</span> DEA", showarrow=False, xanchor="left", font=dict(color="#AAA", size=14))
